...
int SERVO_MOTOR_FREQUENCY = 50; //#In Hz
float SERVO_MOTOR_DUTY_CYCLE_MIN = 2.5;  //# Min duty cycle, in %
float SERVO_MOTOR_DUTY_CYCLE_MAX = 12.5;  //# Max duty cycle, in %
int SERVO_MOTOR_ANGLE_MIN = 0;  //# Min angle, in degrees
int SERVO_MOTOR_ANGLE_MAX = 270;  //# Max angle, in degrees
int PWM_BOARD_RESOLUTION = 4096; //# PWM control board resolution

int atp(int angle){ //convert_to_pwm
